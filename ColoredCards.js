        ...
        renderItem={({item, index}) => (
          <View
            ...
            <ColoredCard
              ...
              cardBackground={
                item.backgroundColor ? item.backgroundColor : '#399ce3'
              }
              ...
              cardBorderRadius={
                item.cardBorderRadius ? item.cardBorderRadius : 20
              }
              cardPadding={item.cardPadding ? item.cardPadding : 16}
              primaryTextColor={
                item.primaryTextColor ? item.primaryTextColor : 'white'
              }
              primaryTextSize={item.primaryTextSize ? item.primaryTextSize : 28}
              primaryTextWeight={
                item.primaryTextWeight ? item.primaryTextWeight : 'bold'
              }
              primaryTextTop={item.primaryTextTop ? item.primaryTextTop : 15}
              secondaryTextColor={
                item.secondaryTextColor ? item.secondaryTextColor : 'white'
              }
              secondaryTextSize={
                item.secondaryTextSize ? item.secondaryTextSize : 16
              }
              ...
              buttonBackground={
                item.buttonBackground ? item.buttonBackground : '#05ada5'
              }
              buttonBorderRadius={
                item.buttonBorderRadius ? item.buttonBorderRadius : 12
              }
              buttonPadding={item.buttonPadding ? item.buttonPadding : 8}
              buttonTextColor={
                item.buttonTextColor ? item.buttonTextColor : 'white'
              }
              buttonTextAlign={
                item.buttonTextAlign ? item.buttonTextAlign : 'center'
              }
              buttonTextBottom={
                item.buttonTextBottom ? item.buttonTextBottom : 8
              }
